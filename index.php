...
echo "<script type='text/javascript'> document.location = 'apply-leave.php';
alert('Hi , Please Click To Continue');
    ...
    <body>
        ...
        <div class="loader">
            <div class="preloader-wrapper big active">
                ...
                <div class="spinner-layer spinner-spinner- orange accent-4
 orange accent-4
 orange accent-4
orange accent-4 lighten-1">
                    <div class="circle-clipper left">
                        <div class="circle"></div>
                    </div><div class="gap-patch">
                    <div class="circle"></div>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="amber darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title" style = "text-transform: none !important">GH Emp-Leave Management Admin Panel</span>
                        </div>
          ...
          <div class="footer">
                   <p class="copyright">Internal Project By <a href="https://www.gridshub.com/">Grids Hub</a></p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style = "Text Transform:none !important;margin-left:135px"><h4>Welcome to Employee Leave Management System</h4></div>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                   ...
                                                   <input type="submit" name="signin" value="Sign in" class="waves-effect waves-light btn  orange accent-4
 orange accent-4
 orange accent-4
orange accent-4">
                                               </div>
