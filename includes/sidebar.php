                ...
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        ...
                        <div class="sidebar-profile-info">
                            ...
                            ?>
                                <p>Hello, &nbsp;<?php echo htmlentities($result->FirstName." ".$result->LastName);?></p>
                                <span>Emp ID : <?php echo htmlentities($result->EmpId)?></span>
                                <p>Department :</p> <span><?php echo htmlentities($result->Department)?>
                                </span>
                         <?php }} ?>
                        </div>
                    </div>
